...
DATASET_SRC="${DATASET_SRC:-$HOME/other/new_data/larger_data_shortgop_resized}"

# ============================================================================
# --- Scratch storage: copy dataset to local NVMe to eliminate NFS I/O spikes ---
# Set USE_SCRATCH=0 to skip scratch copy and train directly from NFS.
# ============================================================================
...
# USE_SCRATCH=1 MIXED_PRECISION=bf16 MAX_EPISODES=50 \
# USE_NORMALIZATION=1 ORI_IMAGE_NORM=1 \
# EXPT_NAME=aug18_v4_allnormed \
